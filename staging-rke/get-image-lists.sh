...
RKE2_VERSIONS="v1.22.12+rke2r1 v1.23.9+rke2r1 v1.24.3+rke2r1 v1.21.14+rke2r1"
#RANCHER_VERSIONS="v2.5.5 v2.5.7 v2.5.8 v2.5.9 v2.5.11 v2.6.0 v2.6.1 v2.6.2 v2.6.3 v2.6.4 v2.6.5 v2.6.6"
RANCHER_VERSIONS="v2.6.7"
